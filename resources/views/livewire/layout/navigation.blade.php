...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16" style="flex-wrap: nowrap; width: 100%">
            <div class="flex w-full">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" style="width: 100%; justify-content: center">
                    ...
                    <x-nav-link :href="route('companies')" :active="request()->routeIs('companies')" wire:navigate>
                        {{ __('Companies') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('billing-details')" :active="request()->routeIs('billing-details')" wire:navigate>
                        {{ __('Billing details') }}
                    </x-nav-link>
